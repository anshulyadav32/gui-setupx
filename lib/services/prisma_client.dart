  ...
  Future<List<Map<String, dynamic>>> getCommonTools() async {
    ...
    return [
      ...
      },
      {
        'id': '24',
        'name': 'wsl_ubuntu',
        'displayName': 'WSL Ubuntu 22.04',
        'icon': 'terminal',
        'color': '#E95420',
        'status': 'unknown',
        'version': null,
        'description': 'Ubuntu 22.04 LTS on WSL with root user',
        'isActive': true,
        'order': 24,
      },
      {
        'id': '25',
        'name': 'wsl_kali',
        'displayName': 'WSL Kali Linux',
        'icon': 'security',
        'color': '#557C94',
        'status': 'unknown',
        'version': null,
        'description': 'Kali Linux on WSL for penetration testing',
        'isActive': true,
        'order': 25,
      },
      {
        'id': '26',
        'name': 'wsl_kali_kex',
        'displayName': 'WSL Kali with KEX',
        'icon': 'security',
        'color': '#557C94',
        'status': 'unknown',
        'version': null,
        'description': 'Kali Linux with KEX GUI support',
        'isActive': true,
        'order': 26,
      },
    ];
