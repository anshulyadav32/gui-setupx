...
class DevToolsView extends StatelessWidget {
  ...
  final Function(DevTool) onInstall;
  final Function(DevTool) onCheck;
  final Function(DevTool) onTest;
  final Function(DevTool) onRemove;
  final Function(DevTool) onReinstall;
  final Function(DevTool) onUpdate;
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            child: _buildDevToolCard(context, tool, isMobile),
                          );
                        },
                      ),
                    );
  ...
  Widget _buildDevToolCard(BuildContext context, DevTool tool, bool isMobile) {
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
              // Icon
              Icon(
                IconHelper.getDevToolIcon(tool.icon ?? 'code'),
                size: isMobile ? 32 : 40,
                color: color,
              ),
