...
class PackageManagerView extends StatelessWidget {
                  ...
                  child: packageManagers.isEmpty
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildPackageManagerCard(manager);
                          },
                        ),
                ),
              ),
  ...
  Widget _buildPackageManagerCard(Map<String, dynamic> manager) {
    final name = manager['displayName'] ?? manager['name'] ?? 'Unknown';
    final iconName = manager['icon'] ?? 'inventory_2';
    final colorHex = manager['color'] ?? '#007ACC';
    final status = manager['status'] ?? 'available';
        ...
        child: Column(
          ...
          children: [
            ...
            if (!isInstalled) ...[
              ...
              // Action buttons for installed managers
              Row(
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
